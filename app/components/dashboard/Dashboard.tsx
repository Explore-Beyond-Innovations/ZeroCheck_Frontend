...
const Dashboard = () => {
  return (
    <section
      className={`bg-[#EDEDED] min-h-screen h-screen overflow-auto py-4 px-8 relative ${poppins.className}`}
    >
            ...
            <div className="flex gap-8 items-center w-[220px]">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  <h4 className="font-semibold text-sm text-black">Jane Doe</h4>{" "}
                  <span className="bg-[#219653] rounded-full w-3 h-3"></span>
                </div>
                <p className="font-medium text-xs text-black">0x1234...5678</p>
              </div>
            </div>
          </Card>
        </div>
