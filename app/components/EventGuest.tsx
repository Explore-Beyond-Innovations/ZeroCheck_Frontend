...
const EventsGuest = () => {
  return (
    <div className="flex">
      ...
      >
        <header className="flex justify-between items-center w-full mx-auto mt-12 mb-6">
          ...
          <div className="flex gap-6 items-center">
            <button className="custom-button w-[181px] h-[40px] text-[15px] bg-black px-16 py-4 font-bold">
              Log In
            </button>
          </div>
        </header>
          ...
          <Card>
            <div className="px-7 py-5 flex flex-col gap-6">
              <div className="w-[38%] flex flex-col gap-6">
                ...
                <p>
                  Discover events happening around you, explore by category, or
                  dive into curated community calendars for exciting options
                </p>
              </div>
